						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									<!--begin::Title-->
									<h1 class="page-heading d-flex text-dark fw-bold flex-row fs-2 my-0">
								...
								<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
									...
									<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 mb-md-5 mb-xl-10">
										<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-100 mb-5 mb-xl-10"
											style="background-color: #080655;background-image:url('assets/media/patterns/vector-1.png')">
											<!--begin::Header-->
											<div class="card-header pt-5">
												...
												<div class="card-title d-flex flex-column">
													<!--begin::Amount-->
													<span
														class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2 flex-row">$<span
															id="balance"></span></span>
													<!--end::Amount-->
													<!--begin::Subtitle-->
													<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Available
														Balance</span>
													<!--end::Subtitle-->
												</div>
												<!--end::Title-->
											...
											<!--end::Header-->
											<div class="d-flex align-items-center flex-wrap d-grid gap-2 ms-10 mt-5">
												<!--begin::Item-->
												<div class="d-flex align-items-center me-5 me-xl-13">
													...
													<div class="text-white">
														<span class="fw-semibold d-block fs-8 opacity-75">KYC
															Level</span>
														<span class="fw-bold fs-7">Level 3</span>
													</div>
													<!--end::Info-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex align-items-center">
													...
													<!--begin::Info-->
													<div class="text-white">
														<span class="fw-semibold opacity-75 d-block fs-8">Account
															ID</span>
														<span class="fw-bold fs-7" id="accountID"></span>
													</div>
													<!--end::Info-->
												</div>
												<!--end::Item-->
											</div>
											<div class="card-body d-flex align-items-end mt-n10">
												<!--begin::Progress-->
												<div class="d-flex align-items-center flex-column mt-3 w-100">
													<div
														class="d-flex justify-content-between fw-bold fs-6 text-white opacity-75 w-100 mt-auto mb-2">
														<span class="d-flex flex-row"><span id="t1" class="me-2"></span>
															Transactions</span>
														<span>72%</span>
													</div>
													...
													async>
														{
															"symbols": [
																...
																[
																	"USDT",
																	"CRYPTOCAP:USDT|1D|USD"
																],
																[
																	"SOLUSD",
																	"COINBASE:SOLUSD|1D|USD"
																],
																[
																	"FX:GBPAUD|1D|USD"
																],
																...
																[
																	"BNB",
																	"CRYPTOCAP:BNB|1M|USD"
																],
																[
																	"DOGE",
																	"CRYPTOCAP:DOGE|1M|USD"
																],
																[
																	"ICP",
																	"CRYPTOCAP:ICP|1M|USD"
																]
															],
																"chartOnly": false,
																	"width": "100%",
										...
										<div class="card card-flush h-md-100">
											...
											<div class="card-header pt-7">
												...
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-gray-800">Transaction
														History</span>
