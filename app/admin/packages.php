								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
										<li class="breadcrumb-item text-muted">
											<div class="text-muted text-hover-primary">Welcome back to
												AstroFx</div>
										</li>
									</ul>
								</div>
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									<button onclick="admin.viewPackage()" class="btn btn-sm fw-bold btn-primary">Add
										New Package</button>
								</div>
							</div>
						</div>
										...
										<div class="card card-flush h-md-100">
											<div class="card-header pt-7">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-gray-800">All Packages</span>
			...
			<div class="modal fade" id="editPackageMOdal" tabindex="-1" style="display: none;" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered mw-450px">
					<div class="modal-content rounded">
						...
						<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
							<form id="updateP" class="form fv-plugins-bootstrap5 fv-plugins-framework">
								<div class="mb-13 text-center">
									<h1 class="mb-3 packageT">Package</h1>
								</div>
								<div class="row g-9 mb-8">
									<div class="col-md-12">
								...
								<div class="row g-9 mb-8">
									...
									<div class="col-md-6">
										...
										<div class="position-relative d-flex align-items-center">
											<input type="number" class="form-control form-control-solid"
												id="ppercentage" name="ppercentage">
										</div>
									</div>
								</div>
								<div class="row g-9 mb-8">
