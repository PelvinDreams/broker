...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
	...
	<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
		<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									<h1 class="page-heading d-flex text-dark fw-bold flex-row fs-2 my-0"><span id="firstname" class="ms-2"></span></h1>
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
										<li class="breadcrumb-item text-muted">
											<a href="#" class="text-muted text-hover-primary">Welcome back
												Admin</a>
										</li>
									</ul>
								</div>
								...
								<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
										...
										<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
											...
											<div class="card-body d-flex align-items-end mb-3">
												<div class="d-flex align-items-center">
													<span class="fs-4hx text-white fw-bold me-6 active_users">0</span>
												</div>
											</div>
											<div class="card-footer"
												style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
												<div class="fw-bold text-white py-2">
													<span class="fs-5 d-block">Active Users</span>
												</div>
											</div>
										</div>
									</div>
									<div class="col-xl-3">
										<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
											...
											<div class="card-body d-flex align-items-end mb-3">
												<div class="d-flex align-items-center">
													<span class="fs-4hx text-white fw-bold me-6 s_users">0</span>
												</div>
											</div>
											<div class="card-footer"
												style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
												<div class="fw-bold text-white py-2">
													<span class="fs-5 d-block">Suspended</span>
												</div>
											</div>
										</div>
									</div>
												...
												<div class="row align-items-center">
													<div class="col-sm-7 pe-0 mb-5 mb-sm-0">
														<div
															...
															<div class="mb-7">
																<div class="mb-6">
																	<h3 class="fs-2x fw-semibold text-white">USDT Wallet
																		Address</h3>
																</div>
																<div
																	...
																	<div
																		...
																		<div class="m-0">
																			<div
																				...
																				Wallet</div>
																			<span
																				class="fw-bold text-white fs-7 d-block dwallet">0xb3baae96e854ac1f9e6a859c3215885123e1c55d</span>
																		</div>
																	</div>
																	<div class="d-flex align-items-center">
																		<div
																		...
																		<div class="m-0">
																			<div
																				...
																				Network</div>
																			<span
																				class="fw-bold text-white fs-7 d-block dnetwork">TRC20</span>
																		</div>
																	</div>
																</div>
															</div>
															<div class="m-0">
																<button
																	...
																	data-bs-target="#update_wallet">Update
																	Wallet</button>
															</div>
														</div>
													</div>
										...
										<div class="card card-flush h-md-100">
											<div class="card-header pt-7">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-gray-800">Recent Deposit</span>
			...
			<div class="modal fade" id="update_wallet" tabindex="-1" style="display: none;" aria-hidden="true">
						...
						<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
							<form id="fwallet" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
								<div class="mb-13 text-center">
									<h1 class="mb-3">Update Wallet Address</h1>
								</div>
								<div class="row g-9 mb-8">
									<div class="col-md-12">
										<label class="required fs-6 fw-semibold mb-2">Wallet Address</label>
										<div class="position-relative d-flex align-items-center">
											<textarea class="form-control form-control-solid" id="walletd"
												name="walletd"></textarea>
										</div>
									</div>
									<div class="col-md-12">
										<label class="required fs-6 fw-semibold mb-2">Network</label>
										<div class="position-relative d-flex align-items-center">
											<input type="text" class="form-control form-control-solid"
												placeholder="TRC20" id="networkd" name="networkd">
										</div>
									</div>
								</div>
								<div class="text-center">
									...
									<button type="button" onclick="admin.updateWallet()" class="btn btn-primary">
