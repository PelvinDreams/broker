...
<head>
	...
	<meta name="keywords"
		content="leading, crypto, copytrading, navigating, digital, assets" />
			...
			<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
				...
				<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
					...
					<div class="d-flex flex-column flex-column-fluid">
						...
						<div class="tradingview-widget-container mb-10">
												...
												<form id="withdral">
													<div class="row g-9 mb-8">
														<div class="col-md-6 fv-row fv-plugins-icon-container">
															<label class="required fs-6 fw-semibold mb-2">Coin Name</label>
															<select id="name" readonly name="name" class="form-select form-select-solid"
																data-control="select2" data-hide-search="true" name="target_assign"
														...
														<div class="col-md-6 fv-row fv-plugins-icon-container">
															<label class="required fs-6 fw-semibold mb-2">Select Network</label>
															<select id="network" name="network" class="form-select form-select-solid"
																data-control="select2" data-hide-search="true" name="target_assign"
																data-select2-id="select2-data-13-g7kh" tabindex="-1" aria-hidden="true"
																data-kt-initialized="1">
													...
													<div class="col-md-12 fv-row mt-10">
															<label class="required fs-6 fw-semibold mb-2">Amount (USD) </label>
															<div class="position-relative d-flex align-items-center">
																<input type="number" class="form-control form-control-solid amount" id="amount" placeholder="USD" name="amount">
															</div>
														</div>
													<div class="col-md-12 fv-row mt-10">
														<label class="required fs-6 fw-semibold mb-2">Wallet Address</label>
														<div class="position-relative d-flex align-items-center">
															<textarea class="form-control form-control-solid wallet" id="wallet" placeholder="0xb3baae96e854ac1f9e6a859c3215885123e1c55d" name="wallet"></textarea>
														</div>
														<input type="hidden" id="userid" name='userid'>
													</div>
													<button type="button" onclick="main.withdrawal('withdral')" class="btn btn-primary mt-10">
							...
							<div id="kt_app_footer" class="app-footer">
								...
								<div
									...
									<div class="text-dark order-2 order-md-1">
										...
										<a href="#" target="_blank" class="text-gray-800 text-hover-primary"> AstroFx All
											Right
											Reserved</a>
									</div>
									<!--end::Copyright-->
					...
					<div class="modal-content rounded">
						...
						<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
							...
							<form id="fwallet" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
								<!--begin::Heading-->
								<div class="text-center">
									<div class="text-muted fw-semibold fs-5">Scan and send $<span id="d_amount2">400</span> to your wallet in
									</div>
								</div>
								<div class="g-9 mb-8">
									...
									<div onclick="main.clickCopy()" class="notice d-flex bg-light-primary rounded border-primary border border-dashed flex-shrink-0 p-3">
										<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap overflow-auto">
											<div class="mb-3 mb-md-0 fw-semibold">
												<div class="fs-6 text-gray-700 pe-7" id="waddress">0xb3baae96e854ac1f9e6a859c3215885123e1c55d</div>
											</div>
										</div>
						...
						<div class="modal-body scroll-y ">
							...
							<img src="assets/media/success.gif" alt="user" height="80px" class="ms-18">
								<div class="mb-3 text-center">
									<div class="text-muted fw-bold fs-5 successModal">Withdrawal successful. Waiting approval
									</div>
								</div>
								<div class="text-center">
									<button type="button" onclick="window.location.href='history.php'" class="btn btn-light btn-sm" data-bs-dismiss="modal">
					...
					<div class="modal-content rounded">
						<div class="modal-body scroll-y ">
							...
							<img src="assets/media/error.gif" alt="user" height="80px" class="ms-18">
								<div class="mb-3 text-center">
									<div class="text-muted fw-bold fs-5 errorModal">Withdrawal successful. Waiting approval
									</div>
								</div>
								<div class="text-center">
